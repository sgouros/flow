class Document < ActiveRecord::Base
  ...
  def inspect
    ...
    "\tregistered_to_central_protocol_db:"     + "#{registered_to_central_protocol_db}"      + "\n" +   
    "\tcomments:"          + "\t\t"   + "#{comments}"           + "\n" +
  ...
  def self.archived
    where("documents.dispatch_stage_id =?",G::DDS_ARCHIVED)
  end

  def self.not_registered_to_central_protocol_db
    where("documents.registered_to_central_protocol_db =?",'false')
  end
