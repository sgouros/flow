Flow::Application.routes.draw do
  ...
  # Eκεί ποστάρει ο Σπύρος όταν επιλέγει ποιά archived πέρασε στην κεντρική εφαρμογή πρωτοκόλου 
  match '/register_to_central_protocol_db' => "documents#register_to_central_protocol_db"
